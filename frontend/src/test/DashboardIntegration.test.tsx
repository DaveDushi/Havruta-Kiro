...
const mockHavrutot = [
  {
    ...
    participants: [{ user: { id: 'user1', name: 'User 1', email: 'user1@example.com' } }, { user: { id: 'user2', name: 'User 2', email: 'user2@example.com' } }],
  ...
  },
  {
    ...
    ownerId: 'user1',
    owner: { id: 'user1', name: 'User 1', email: 'user1@example.com' },
    participants: [{ user: { id: 'user1', name: 'User 1', email: 'user1@example.com' } }, { user: { id: 'user3', name: 'User 3', email: 'user3@example.com' } }],
    lastPlace: 'Berakhot 2a',
    isActive: true,
  ...
  },
  {
    ...
    ownerId: 'user1',
    owner: { id: 'user1', name: 'User 1', email: 'user1@example.com' },
    participants: [{ user: { id: 'user1', name: 'User 1', email: 'user1@example.com' } }, { user: { id: 'user4', name: 'User 4', email: 'user4@example.com' } }, { user: { id: 'user5', name: 'User 5', email: 'user5@example.com' } }],
    lastPlace: 'Mishnah Berakhot 1:1',
    isActive: false,
